        ...
        <div class="row ">
          ...
          <div class="col-md-6 offset-md-3 ">.
            <div class=" form-group ">
              <h1 class="text-center " style="display: block;color: #ffaa00; ">Create Supporter Account </h1>
            ...
            <div class="form-group ">
              <label style="display: block;color: #ffaa00; " for="mobile ">New Password:</label>
              <input type="password" class="form-control" placeholder="Enter New Password">
            </div>
            <div class="form-group ">
              <label style="display: block;color: #ffaa00; " for="mobile ">Repeat Password:</label>
