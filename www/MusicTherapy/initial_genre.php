...
<head>
    ...
    <head>
        ...
        <link rel="stylesheet" href="./styles/initialLists.css" />
...
<body>
      ...
      <div class="collapse  navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto justify-right">
          <li class="nav-item active">
            <a
              class="nav-link font-nav-custom-color hora"
    ...
    <div class="sidebar bg-dark" id="sidebar" style="padding-top: 35px;">
      ...
      >
      <a style="font-size: 20px;" href="./search.html"
        ><i class="fas fa-search"></i> Search</a
      >
      <a style="font-size: 20px;" href="./Your-Library.html"
        ><i class="fas fa-list-music"></i> Your Library</a
      >
    ...
    <div class="row">
      ...
      <ul class=" ula nav navbar-horizontal active row col-lg-11">
        ...
        <div class="pl container-fluid">
            <div class=" row horizontal ">
                <div class="col-lg-12">
                    <p style="color: white; font-size:70px; padding-top: 50px; text-align: center; ">
                        Save Your Favourite Genre.
                    </p>
                </div>
            </div>
            ...
            <div class=" row horizontal ">
                <div class="col-lg-12">
                    <p style="color: white; font-size:20px; padding-top: 6px; text-align: center; ">
                        Save genre you love to build the collection of your dreams.
                    </p>
                </div>
            </div>
            <div class=" row horizontal ">
                ...
                <div class="col-lg-4">
                    <button class="creat-button btn  btn-outline-warning btn-light" style="margin-left: -10px; width: 270px; margin-top: 20px; border-radius: 50px;  color: white; font-size:20px; ">
            <p
              style="text-align: center; margin-top: 7px; color: #222222; width: 250px;"
            >
              SEARCH
            </p>
          </button>
        ...
        <nav class=" navbar shadow navbar-expand-lg navbar-dark bg-dark fixed-bottom" style=" height: 80px; width:100%; margin-left:0px">
            <div class="row" style="width:100%; ">
                <div class="col-lg-2">
                    <h4 class="sna" style="color: white; text-align: center; margin: 0px;"></h4>
                </div>

                <audio src="" autoplay loop class="player col-lg-8 " controls></audio>
