...
<head>
    ...
    <head>
        ...
        <link rel="stylesheet" href="./styles/ChoosePlayList.css">
...
<nav class="navbar fixed-top navbar-expand-md navbar-dark bg-dark" id="topbar">
    ...
    <!-- Modal -->
    <form action="choose_playlist.php" method="POST">
...
$stmt->execute([ $stmtID,$_SESSION['userIDlogin'], $namePlaylist, date("Y/m/d"),$typePlaylist,NULL,date("Y/m/d"),NULL]);
    ...
    <div class=" row horizontal ">
        ...
        <div class="col-lg-12 ">
            <div class="yourlist">
                ...
                <p style="color: royalblue; font-size:35px; padding-top: 6px;">
                ...
                <div class="a ih-item square colored effect6 mrgn-top ">
                    <a href="#">
                        ...
                        <div class="info">
                            ...
                            <p>
                                <h2 style="color:rgb(210,0,0);">PlayList Name</h2>


                                <img style="width: 50%; height: 50%;" src="./images/Add.png">
    ...
    <script src="./script/ChoosePlayList.js">
    </script>
