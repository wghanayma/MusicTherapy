...
<head>
  ...
  <title>Hello To Music Therapy Login or Sign up to gain a full access to our Music Library</title>
  <link rel="stylesheet" href="./styles/guest.css" />
  <script src="./script/guest.js"></script>
</head>

<body>
  <nav class="navbar fixed-top navbar-expand-md navbar-dark transparent" id="topbar">
    <div class="justify-center" style="margin-left:3.5px;display: inline-flex;">
      <a href="./index.php"><img src="./images/Logo.png" href="./index.html" class="mx-auto d-block" style="width:55px;height:55px"></a>
  ...
  <div class="box">
    <div class="text-center " style="margin-bottom: 200px;">
      <h1 style="margin-bottom: 50px;">Music for Every Mood</h1>
      <h4>we currently have about a ten thosand songs</h4>
      <h4>Start up today and play your favorite songs.</h4>
    </div>
