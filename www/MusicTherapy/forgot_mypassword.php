...
<body>
  ...
  <div class="container">
    ...
    <form method="post" action="Verify.html">
      ...
      <h4 style="text-align: center;">Enter your email address, if it exist we will send you an email<br> with a link to reset your password.</h4>
      <div class="container">
        <h3 style="color: #ffaa00;">Email Address:</h3>
        <input required class="form-control" type="email" name="VerificationCode" placeholder="Email Address">
        <button type="submit" class="btn btn-success btn-block justify-center Verify-btn" type="button">Send</button>
        <h5 style="text-align: center;margin-top:50px;">if you did not receive an email check the spam folder or
          <a href="./request_new_passlink.php" style="color: #ffaa00;">Press here to request a new one</a></h5>
        <!-- TODO -->
