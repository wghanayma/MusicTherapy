      ...
      <div class="form-group">
        ...
        <div class="input-group search-style ">
          ...
          <div class="input-group-append">
            <button class="btn" type="button" style="border-top: 1px solid white;
        ...
        <div class="text-center">
          ...
          <form>
            <label class="text-light radio-inline">
                                    <input type="radio" name="song_name">Song Name</label>
            <label class=" text-light radio-inline">
                                    <input type="radio" name="genre">Genre</label>
            <label class=" text-light radio-inline">
                                    <input type="radio" name="albums" checked>Albums</label>
            <label class="text-light radio-inline">
                                        <input type="radio" name="playlist">Playlist</label>

            <label class=" text-light radio-inline">
                                    <input type="radio" name="username">Username</label>
        </div>
      </div>
    </div>
  </div>
