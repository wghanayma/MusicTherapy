    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-primary" style="margin-right: 80px; position: fixed; bottom:3%; right:5%; z-index:1000;">
          Save changes
        </button>
          <button type="button" class="btn btn-secondary" data-dismiss="modal" style="position: fixed; bottom:3%;right:5%; z-index: 1000;">
          Close
        </button>
        </div>
      </div>
        ...
        <div class="text-center">
          ...
          <div class="text-center">
            <div class="col-md-3  ">
              ...
              <div class="btn-group">
                <button type="button" class="btn add-song    " data-toggle="dropdown">Add Song<span class="caret"></span></button>
              ...
              <div class="col-xs-3 col-sm-3 col-md-3 ">
                ...
                <div id="add_button" class="btn-group flex_nav" type="button">
                  ...
                  <div class="dropdown-menu">
                    ...
                    <button type="button" class="dropdown-item btn btn-primary" data-toggle="modal" data-target="#exampleModalLong1">user</button>
                    <!-- Modal -->
                    <!-- Button trigger modal -->
                    <button type="button" class="dropdown-item btn btn-primary" data-toggle="modal" data-target="#exampleModalLong">global</button>
                    <!-- Modal -->
                  </div>
                </div>
