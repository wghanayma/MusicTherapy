...
<head>
  ...
  <title>Music Therapy - Support</title>
...
<body>
  ...
  <div class="container">
    ...
    <form method="post" action="">
      ...
      <input class="form-control" required type="email" name="EmailAddress" placeholder="Email Address">
      <textarea id="my-textarea" required class="form-control" aria-setsize="false" name="Message" rows="15" placeholder="Your Message or Feedback" style="resize: none;"></textarea>
      <button type="submit" class="btn btn-success btn-block justify-center Send-btn" type="button">Send</button>
    </form>
  </div>
</body>
