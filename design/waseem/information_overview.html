...
<head>
  ...
  <link rel="stylesheet" href="./styles/information_overview.css" />
...
<body>
  ...
  <div class="container h-100 ">
    ...
    <div class=" row h-100    align-items-center">
      ...
      <div id="main1" class="col-md-6 offset-md-3 ">
        <div class=" form-group ">
          <h1 class="text-center " style="display: block;color: #ffaa00; ">Account Profile Overview </h1>
          <hr style="background-color: #ffaa00;" lass="style1 ">

        </div>


        <div class="form-group row ">
          <label style="text-align: center;display: block;color: #ffaa00; " for="staticEmail " class="col-sm-6 col-form-label ">Username</label>
          <div class="col-sm-6 ">
            <input style="text-align: center;display: block; color: #ffaa00; " type="text " readonly class="form-control-plaintext " id="staticEmail " value="heool">
          </div>
        </div>
        <div class="form-group row ">
          <label style="text-align: center;display: block;color: #ffaa00; " for="staticEmail " class="col-sm-6 col-form-label ">Gender</label>
          <div class="col-sm-6 ">
            <input style="text-align: center;display: block; color: #ffaa00; " type="text " readonly class="form-control-plaintext " id="staticEmail " value="Male ">
          </div>
        </div>
        <div class="form-group row ">
          <label style="text-align: center;display: block;color: #ffaa00; " for="staticEmail " class="col-sm-6 col-form-label ">Data of birth</label>
          <div class="col-sm-6 ">
            <input style="text-align: center;display: block; color: #ffaa00; " type="text " readonly class="form-control-plaintext " id="staticEmail " value="11/1/1994 ">
          </div>
        </div>
        <div class="form-group row ">
          <label style="text-align: center;display: block;color: #ffaa00; " for="staticEmail " class="col-sm-6 col-form-label ">Country</label>
          <div class="col-sm-6 ">
            <input style="text-align: center;display: block; color: #ffaa00; " type="text " readonly class="form-control-plaintext " id="staticEmail " value="Palestine ">
          </div>
        </div>
        <div class="form-group row justify-center">
          <button href="./edit_account_information_overview.html" type="button " class="btn btn-primary ">EDIT PROFILE</button>
