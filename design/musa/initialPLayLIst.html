      ...
      <ul class=" ula nav navbar-horizontal active row col-lg-11">
        ...
        <div class="pl container-fluid">
            ...
            <div class=" row horizontal ">
                ...
                <div class=" col-lg-4 ">
                    <button data-toggle="modal" data-target="#exampleModal" class="creat-button btn btn-outline-warning btn-light" style="margin-left: -10px; width: 270px;  margin-top: 20px; border-radius: 50px;  color: white; font-size:20px; ">
            <p style="text-align: center; margin-top: 7px; color: #222222;">
              CREAT NEW PLAYLIST
            </p>
          </button>
                </div>
        ...
        <script>
            ...
            // cplb.addEventListener("click", function(event) {
            //     fcpl(event);
            // });
        </script>
</body>
