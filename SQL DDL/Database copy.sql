...
CREATE TABLE `SongArtistTable` (
  `SongID` varchar(32) NOT NULL,
  `ArtistID` varchar(32) NOT NULL,
  `SongPath` varchar(384) NOT NULL,
  `AlbumID` varchar(32) NOT NULL,
  PRIMARY KEY (`SongID`,`ArtistID`,`SongPath`,`AlbumID`),
  KEY `SongArtistTable_FK_ArtistTable` (`ArtistID`),
  KEY `SongArtistTable_FK` (`SongID`,`AlbumID`,`SongPath`),
  CONSTRAINT `SongArtistTable_FK` FOREIGN KEY (`SongID`, `AlbumID`, `SongPath`) REFERENCES `SongTable` (`ID`, `AlbumID`, `Path`),
